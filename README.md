...
| ライブラリ | バージョン | ライセンス | 形式 |
|---|---|---|---|
| [cpp-httplib](https://github.com/yhirose/cpp-httplib) | 0.46.1 | MIT | ヘッダオンリー (`third_party/httplib.h`) |
| [nlohmann/json](https://github.com/nlohmann/json) | 3.12.0 | MIT | ヘッダオンリー (`third_party/json.hpp`) |
| [Leaflet.js](https://leafletjs.com/) | 1.9.4 | BSD-2-Clause | バンドル (`web/lib/`) |

システム依存:

| ライブラリ | 用途 |
|---|---|
| `librt` | POSIX SHM (`shm_open`, `mmap`) |
| `libpthread` | スレッド |
